...
class TeamMembersControllerTest < ActionController::TestCase
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post :create, team_member: { email: @team_member.email, linkedin: @team_member.linkedin, nome: @team_member.nome, role: @team_member.role }
    end
  ...
  test "should update team_member" do
    patch :update, id: @team_member, team_member: { email: @team_member.email, linkedin: @team_member.linkedin, nome: @team_member.nome, role: @team_member.role }
    assert_redirected_to team_member_path(assigns(:team_member))
  end
